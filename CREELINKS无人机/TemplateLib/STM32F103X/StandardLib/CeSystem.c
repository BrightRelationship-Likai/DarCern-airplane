...
const char ceStatusString[9][30] = {{"CE_STATUS_FAILE"},{"CE_STATUS_SUCCESS"},{"CE_STATUS_RESOURCE_ERROR"},{"CE_STATUS_INITIAL_FALSE"},{"CE_STATUS_NULL_POINTER"},{"CE_STATUS_MALLOC_FALSE"},{"CE_STATUS_PAR_ERROR"},{"CE_STATUS_OUT_TIME"},{"UnknowError"}};
...
/**
  ...
  * @return  状态指示码
  */
void ce_assert_failed(uint8* file, uint32 line, CE_STATUS ceStatus)
{
...
const char* ceSystem_getErrorMsg(CE_STATUS ceStatus)
{
	...
	switch(ceStatus)
	{
		case CE_STATUS_FAILE:index = 0;break;
		case CE_STATUS_SUCCESS:index = 1;break;
		case CE_STATUS_RESOURCE_ERROR:index = 2;break;
		case CE_STATUS_INITIAL_FALSE:index = 3;break;
		case CE_STATUS_NULL_POINTER:index = 4;break;
		case CE_STATUS_MALLOC_FALSE:index = 5;break;
		case CE_STATUS_PAR_ERROR:index = 6;break;
		case CE_STATUS_OUT_TIME:index = 7;break;		
		default:break;
	}

    return ceStatusString[(uint8)index];
}
