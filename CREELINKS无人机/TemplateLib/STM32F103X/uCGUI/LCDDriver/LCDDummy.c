...
#include "CeTft320.h"
CeTft320 ceTft320;
extern void touchPressCallBack(int16 x, int16 y);
...
void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex) {
  ...
  {
    /* ... */
		//CE_TFT320_DRAW_POINT(x,y,(uint16)PixelIndex);
		ceTft320Op.drawPoint(x,y,(uint16)PixelIndex);
  }
}
...
void LCD_L0_FillRect(int x0, int y0, int x1, int y1) {
	//CE_TFT320_DRAW_RECTANGLE(x0,y0,x1,y1,LCD_COLORINDEX);
	ceTft320Op.drawRectangle(x0,y0,x1,y1,(uint16)LCD_COLORINDEX);
}
...
int  LCD_L0_Init(void) {
  //LCD_INIT_CONTROLLER();
	ceTft320Op.initial(&ceTft320,R26L36,touchPressCallBack);
  return 0;
}
